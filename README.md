SpreeSocial
===========
[![Build Status](https://travis-ci.org/spree/spree_social.png?branch=1-3-stable)](https://travis-ci.org/spree/spree_social)
...
Spree::SocialConfig[:path_prefix] = 'user' # for /user/auth/:provider
